...
# Add the parent directory to the path to import magicbot_gen1_python
sys.path.append(os.path.dirname(os.path.dirname(os.path.dirname(os.path.abspath(__file__)))))

try:
    import magicbot_gen1_python as magicbot
except ImportError as e:
    print(f"Error importing magicbot_gen1_python: {e}")
...
def test_joystick_command_left_x_axis():
    ...
    for value in test_values:
        ...
        assert joystick_cmd.left_x_axis == value, f"Left X-axis should be {value}, got {joystick_cmd.left_x_axis}"
    ...
    for value in edge_values:
        joystick_cmd.left_x_axis = value
        print(f"     Set left_x_axis: {value}")
        assert value - 1e-6 < joystick_cmd.left_x_axis < value + 1e-6, f"Left X-axis should be {value}, got {joystick_cmd.left_x_axis}"
...
def test_joystick_command_left_y_axis():
    ...
    for value in test_values:
        ...
        assert joystick_cmd.left_y_axis == value, f"Left Y-axis should be {value}, got {joystick_cmd.left_y_axis}"
    ...
    for value in edge_values:
        joystick_cmd.left_y_axis = value
        print(f"     Set left_y_axis: {value}")
        assert value - 1e-6 < joystick_cmd.left_y_axis < value + 1e-6, f"Left Y-axis should be {value}, got {joystick_cmd.left_y_axis}"
...
def test_joystick_command_right_x_axis():
    ...
    for value in test_values:
        ...
        assert joystick_cmd.right_x_axis == value, f"Right X-axis should be {value}, got {joystick_cmd.right_x_axis}"
    ...
    for value in edge_values:
        joystick_cmd.right_x_axis = value
        print(f"     Set right_x_axis: {value}")
        assert value - 1e-6 < joystick_cmd.right_x_axis < value + 1e-6, f"Right X-axis should be {value}, got {joystick_cmd.right_x_axis}"
...
def test_joystick_command_right_y_axis():
    ...
    for value in test_values:
        ...
        assert joystick_cmd.right_y_axis == value, f"Right Y-axis should be {value}, got {joystick_cmd.right_y_axis}"
    ...
    for value in edge_values:
        joystick_cmd.right_y_axis = value
        print(f"     Set right_y_axis: {value}")
        assert value - 1e-6 < joystick_cmd.right_y_axis < value + 1e-6, f"Right Y-axis should be {value}, got {joystick_cmd.right_y_axis}"
...
def test_joystick_command_typical_scenarios():
    ...
    print(f"     Forward movement: left_x={joystick_cmd.left_x_axis}, left_y={joystick_cmd.left_y_axis}")
    ...
    print(f"     Backward movement: left_x={joystick_cmd.left_x_axis}, left_y={joystick_cmd.left_y_axis}")
    assert joystick_cmd.left_x_axis == 0.0 and joystick_cmd.left_y_axis == -1.0
    ...
    print(f"     Left turn: left_y={joystick_cmd.left_y_axis}, right_x={joystick_cmd.right_x_axis}")
    ...
    print(f"     Right turn: left_y={joystick_cmd.left_y_axis}, right_x={joystick_cmd.right_x_axis}")
    assert joystick_cmd.left_y_axis == 0.5 and joystick_cmd.right_x_axis == 1.0
    ...
    print(f"     Strafe left: left_x={joystick_cmd.left_x_axis}, left_y={joystick_cmd.left_y_axis}")
    ...
    print(f"     Strafe right: left_x={joystick_cmd.left_x_axis}, left_y={joystick_cmd.left_y_axis}")
    assert joystick_cmd.left_x_axis == 1.0 and joystick_cmd.left_y_axis == 0.0
...
def test_joystick_command_edge_cases():
    ...
    print(f"     Max values: left_x={joystick_cmd.left_x_axis}, left_y={joystick_cmd.left_y_axis}, right_x={joystick_cmd.right_x_axis}, right_y={joystick_cmd.right_y_axis}")
    assert joystick_cmd.left_x_axis == 1.0 and joystick_cmd.left_y_axis == 1.0 and joystick_cmd.right_x_axis == 1.0 and joystick_cmd.right_y_axis == 1.0
    ...
    print(f"     Min values: left_x={joystick_cmd.left_x_axis}, left_y={joystick_cmd.left_y_axis}, right_x={joystick_cmd.right_x_axis}, right_y={joystick_cmd.right_y_axis}")
    assert joystick_cmd.left_x_axis == -1.0 and joystick_cmd.left_y_axis == -1.0 and joystick_cmd.right_x_axis == -1.0 and joystick_cmd.right_y_axis == -1.0
    ...
    print(f"     Neutral: left_x={joystick_cmd.left_x_axis}, left_y={joystick_cmd.left_y_axis}, right_x={joystick_cmd.right_x_axis}, right_y={joystick_cmd.right_y_axis}")
    assert joystick_cmd.left_x_axis == 0.0 and joystick_cmd.left_y_axis == 0.0 and joystick_cmd.right_x_axis == 0.0 and joystick_cmd.right_y_axis == 0.0
    ...
    print(f"     Small values: left_x={joystick_cmd.left_x_axis}, left_y={joystick_cmd.left_y_axis}, right_x={joystick_cmd.right_x_axis}, right_y={joystick_cmd.right_y_axis}")
