...
def test_imu_orientation():
    ...
    imu.orientation[0] = test_orientation2[0]
    imu.orientation[1] = test_orientation2[1]
    imu.orientation[2] = test_orientation2[2]
    imu.orientation[3] = test_orientation2[3]
...
def test_imu_angular_velocity():
    ...
    imu.angular_velocity[0] = test_angular_velocity2[0]
    imu.angular_velocity[1] = test_angular_velocity2[1]
    imu.angular_velocity[2] = test_angular_velocity2[2]
...
def test_imu_linear_acceleration():
    ...
    imu.linear_acceleration[0] = test_linear_acceleration2[0]
    imu.linear_acceleration[1] = test_linear_acceleration2[1]
    imu.linear_acceleration[2] = test_linear_acceleration2[2]
